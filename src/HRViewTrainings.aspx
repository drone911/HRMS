<%@ Page Title="" Language="C#" MasterPageFile="~/HRHome.master" AutoEventWireup="true" CodeFile="HRViewTrainings.aspx.cs" Inherits="HRViewTrainings" %>
    ...
    <div>
        <div class="row">
            <div class="form-group col-6">
                <label class="col-form-label" for="TrainingStatus">Training Status</label>
                <asp:DropDownList CssClass="form-control col-8" runat="server" ValidationGroup="vg" ID="TrainingStatus" AutoPostBack="true">
        ...
        <br />
        <asp:Table ID="TrainingTable" runat="server" CssClass="table" CellSpacing="0" Width="100%">
        </asp:Table>
    </div>
    <style>
