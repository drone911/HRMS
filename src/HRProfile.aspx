<%@ Page Title="" Language="C#" MasterPageFile="~/HRHome.master" AutoEventWireup="true" CodeFile="HRProfile.aspx.cs" Inherits="HRProfile" %>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" TextMode="MultiLine" Rows="5" ReadOnly="true" CssClass="form-control" ID="OrganisationAddress" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox ReadOnly="true" runat="server" CssClass="form-control" ID="OrganisationPincode" />
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="OrganisationCity">Organisation City</label>
                            <asp:TextBox ReadOnly="true" runat="server" CssClass="form-control" ID="OrganisationCity" />
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="OrganisationState">Organisation State</label>
                            <asp:TextBox ReadOnly="true" runat="server" CssClass="form-control" ID="OrganisationState" />
                        </div>
                    </div>
                </div>
                <div class="row" style="align-items: center;">
